 ...
 *  - https://mvcncfw.org/meta/gcode
 *  - https://reprap.org/wiki/G-code
 *  - https://linuxcnc.org/docs/html/gcode.html
 *
 * Help to document mvCNC's G-codes online:
 *  - https://github.com/mvCNCFirmware/mvCNCDocumentation
 *
 * -----------------
 *
 * "G" Codes
 ...
 * M202 - Set max acceleration in units/s^2 for travel moves: "M202 X<accel> Y<accel> Z<accel> E<accel>" ** UNUSED IN mvCNC! **
