...
//
//   ==> ALWAYS TRY TO COMPILE mvCNC WITH/WITHOUT "ULTIPANEL" / "ULTRA_LCD" / "SDSUPPORT" #define IN "Configuration.h"
...
#define MVCNC_WEBSITE_URL                   "mvcncfw.org"
...
#define STR_ERR_KILLED                      "CNC halted. kill() called!"
#define STR_FLOWMETER_FAULT                 "Coolant flow fault. Flowmeter safety is active. Attention required."
#define STR_ERR_STOPPED                     "CNC stopped due to errors. Fix the error and use M999 to restart. (Temperature is reset. Set it after restarting)"
...
#define STR_PRINTER_LOCKED                  "CNC locked! (Unlock with M511 or LCD)"
...
#else
  //
  // Custom characters from mvCNC_symbols.fon which was merged into ISO10646-0-3.bdf
