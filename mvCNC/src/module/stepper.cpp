...
/**
 * mvCNC uses the Bresenham algorithm. For a detailed explanation of theory and
...
void Stepper::set_directions() {
   ...
   *  the curve, as mvCNC uses variable timer periods. So, we require a formula of the form:
   *
