...
#if HAS_JOB_PROGRESS && EITHER(PRINT_PROGRESS_SHOW_DECIMALS, SHOW_REMAINING_TIME)
  #define HAS_JOB_PROGRESS_PERMYRIAD 1
#endif

#if ANY(MVCNC_BRICKOUT, MVCNC_INVADERS, MVCNC_SNAKE, MVCNC_MAZE)
  #define HAS_GAMES 1
  #if MANY(MVCNC_BRICKOUT, MVCNC_INVADERS, MVCNC_SNAKE, MVCNC_MAZE)
