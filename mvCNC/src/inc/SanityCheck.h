 ...
 */
  ...
  #error "mvCNC requires C++11 support (gcc >= 4.7, Arduino IDE >= 1.6.8). Please upgrade your toolchain."
#endif
 ...
 * your settings to new Configuration files matching your mvCNC version as soon as possible.
 */
#define HEXIFY(H) _CAT(0x,H)
#if !defined(CONFIGURATION_H_VERSION) || HEXIFY(CONFIGURATION_H_VERSION) < HEXIFY(REQUIRED_CONFIGURATION_H_VERSION)
  #error "Your Configuration.h file is for an old version of mvCNC. Downgrade mvCNC or upgrade your Configuration.h."
#elif HEXIFY(CONFIGURATION_H_VERSION) > HEXIFY(REQUIRED_CONFIGURATION_H_VERSION)
  #error "Your Configuration.h file is for a newer version of mvCNC. Upgrade mvCNC or downgrade your Configuration.h."
#endif
#if !defined(CONFIGURATION_ADV_H_VERSION) || HEXIFY(CONFIGURATION_ADV_H_VERSION) < HEXIFY(REQUIRED_CONFIGURATION_ADV_H_VERSION)
  #error "Your Configuration_adv.h file is for an old version of mvCNC. Downgrade mvCNC or upgrade your Configuration_adv.h."
#elif HEXIFY(CONFIGURATION_ADV_H_VERSION) > HEXIFY(REQUIRED_CONFIGURATION_ADV_H_VERSION)
  #error "Your Configuration_adv.h file is for a newer version of mvCNC. Upgrade mvCNC or downgrade your Configuration_adv.h."
#endif
#undef HEXIFY
 ...
 */
  ...
  #error "SHORT_MANUAL_Z_MOVE is now FINE_MANUAL_MOVE, applying to Z on most cncs."
...
/**
 * mvCNC release, version and default string
 */
...
/**
 * Granular software endstops (mvCNC >= 1.1.7)
 */
 ...
 */
  ...
  #if HAS_MVCNCUI_U8GLIB || LCD_WIDTH < 20 || LCD_HEIGHT < 4
 ...
 */
  ...
  #endif
#elif ENABLED(LCD_SET_PROGRESS_MANUALLY) && NONE(HAS_MVCNCUI_U8GLIB, HAS_GRAPHICAL_TFT, HAS_MVCNCUI_HD44780, EXTENSIBLE_UI, HAS_DWIN_E3V2, IS_DWIN_MVCNCUI)
  #error "LCD_SET_PROGRESS_MANUALLY requires LCD_PROGRESS_BAR, Character LCD, Graphical LCD, TFT, DWIN_CREALITY_LCD, DWIN_CREALITY_LCD_ENHANCED, DWIN_CREALITY_LCD_JYERSUI, DWIN_mvCNCUI_*, OR EXTENSIBLE_UI."
#endif
...
#if !HAS_MVCNCUI_MENU && ENABLED(SD_REPRINT_LAST_SELECTED_FILE)
  #error "SD_REPRINT_LAST_SELECTED_FILE currently requires a mvCNC-native LCD menu."
#endif

/**
 * Custom Boot and Status screens
 */
#if ENABLED(SHOW_CUSTOM_BOOTSCREEN) && NONE(HAS_MVCNCUI_U8GLIB, TOUCH_UI_FTDI_EVE)
  #error "SHOW_CUSTOM_BOOTSCREEN requires Graphical LCD or TOUCH_UI_FTDI_EVE."
#elif ENABLED(CUSTOM_STATUS_SCREEN_IMAGE) && !HAS_MVCNCUI_U8GLIB
 ...
 * SD Card Settings
 */
#if ALL(SDSUPPORT, ELB_FULL_GRAPHIC_CONTROLLER, HAS_MVCNCUI_MENU) && PIN_EXISTS(SD_DETECT) && SD_DETECT_STATE != HIGH && (SD_CONNECTION_IS(LCD) || !defined(SDCARD_CONNECTION))
 ...
 */
  ...
  #elif ENABLED(BABYSTEP_ZPROBE_GFX_OVERLAY) && NONE(HAS_MVCNCUI_U8GLIB, IS_DWIN_MVCNCUI)
 ...
 */
  ...
  #elif ENABLED(MMU_EXTRUDER_SENSOR) && !HAS_MVCNCUI_MENU
    #error "MMU_EXTRUDER_SENSOR requires an LCD supporting mvCNCUI."
  #elif ENABLED(MMU2_MENUS) && !HAS_MVCNCUI_MENU
    #error "MMU2_MENUS requires an LCD supporting mvCNCUI."
  #elif DISABLED(ADVANCED_PAUSE_FEATURE)
 ...
 */
  ...
  static_assert(
    ...
    "LIN_ADVANCE_K must be a value from 0 to 10 (Changed in LIN_ADVANCE v1.5, mvCNC 1.1.9)."
  );
 ...
 */
#if HAS_MVCNCUI_HD44780 && !defined(DISPLAY_CHARSET_HD44780)
 ...
 */
  ...
  #error "Leveling in mvCNC requires three or more axes, with Z as the vertical axis."
 ...
 */
  ...
  #elif ENABLED(DELTA_AUTO_CALIBRATION) && !(HAS_BED_PROBE || HAS_MVCNCUI_MENU)
    #error "DELTA_AUTO_CALIBRATION requires a probe or LCD Controller."
  #elif ENABLED(DELTA_CALIBRATION_MENU) && !HAS_MVCNCUI_MENU
...
/**
 * Some things should not be used on Belt CNCs
 */
 ...
 */
  ...
  #if IS_SCARA
    #error "AUTO_BED_LEVELING_UBL does not yet support SCARA cncs."
  ...
  // Mesh Bed Leveling
  #if ENABLED(DELTA)
    #error "MESH_BED_LEVELING is not compatible with DELTA cncs."
  ...
  #elif NONE(HAS_MVCNCUI_U8GLIB, IS_DWIN_MVCNCUI)
 ...
 */
  ...
  #if NONE(HAS_MVCNCUI_MENU, DWIN_CREALITY_LCD, DWIN_CREALITY_LCD_ENHANCED)
 ...
 */
    ...
    #error "FILAMENT_WIDTH_SENSOR requires USE_VOLUMETRICS to be disabled."
  #endif
#endif
 ...
 */
    ...
    #error "VOLUMETRIC_EXTRUDER_LIMIT requires USE_VOLUMETRICS to be disabled."
 ...
 */
  ...
  #error "An encoder button is required or SOFT_RESET_ON_KILL will reset the cnc without notice!"
#endif
 ...
 */
  ...
  + COUNT_ENABLED(DWIN_CREALITY_LCD, DWIN_CREALITY_LCD_ENHANCED, DWIN_CREALITY_LCD_JYERSUI, DWIN_mvCNCUI_PORTRAIT, DWIN_mvCNCUI_LANDSCAPE) \
...
#if ENABLED(LED_CONTROL_MENU) && NONE(HAS_MVCNCUI_MENU, DWIN_CREALITY_LCD_ENHANCED)
...
#if NONE(HAS_MVCNCUI_U8GLIB, EXTENSIBLE_UI, IS_DWIN_MVCNCUI) && ENABLED(PRINT_PROGRESS_SHOW_DECIMALS)
 ...
 */
  ...
  #if NONE(HAS_MVCNCUI_MENU, PASSWORD_UNLOCK_GCODE, PASSWORD_CHANGE_GCODE)
    #error "Without PASSWORD_UNLOCK_GCODE, PASSWORD_CHANGE_GCODE, or a supported LCD there's no way to unlock the cnc or set a password."
  #elif DISABLED(EEPROM_SETTINGS)
