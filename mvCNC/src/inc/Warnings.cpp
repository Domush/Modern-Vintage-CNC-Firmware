 ...
 */
#ifdef __STM32F1__
  #warning "Maple build environments are deprecated. Please use a non-Maple build environment. Report issues to the Modern Vintage CNC Firmware project."
#endif
