...
/* DGUS VPs changed by George Fu in 2019 for mvCNC */
...
const struct DGUS_VP_Variable ListOfVP[] PROGMEM = {
  ...
  #endif
  #if HAS_HEATED_BED
    VPHELPER(VP_T_Bed_Is, &fanManager.temp_bed.celsius, nullptr, ScreenHandler.DGUSLCD_SendWordValueToDisplay),
  ...
  // Fan Data
    ...
    #define FAN_VPHELPER(N) \
      VPHELPER(VP_Fan##N##_Percentage, &fanManager.fan_speed[N], ScreenHandler.DGUSLCD_PercentageToUint8, ScreenHandler.DGUSLCD_SendPercentageToDisplay), \
