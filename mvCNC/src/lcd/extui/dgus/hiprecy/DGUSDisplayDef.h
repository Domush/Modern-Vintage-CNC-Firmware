...
enum DGUSLCD_Screens : uint8_t {
  ...
  DGUSLCD_SCREEN_SDJOBMANIPULATION  =   7,
  DGUSLCD_SCREEN_SDJOBTUNE          =   9,
...
// 0x3000 .. 0x4FFF  -- mvCNC Data to be displayed
...
constexpr uint16_t VP_UI_FLAVOUR       = 0x1010;  // lets reserve 16 bytes here to determine if UI is suitable for this mvCNC. tbd.
