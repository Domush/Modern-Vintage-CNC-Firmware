 ...
 * Copyright (c) 2021 mvCNCFirmware [https://github.com/mvCNCFirmware/mvCNC]
 *
...
enum class DGUS_Addr : uint16_t {
  ...
  SCREENCHANGE_Idle         = 0x2002, // Only change if not cutting.
  SCREENCHANGE_Cutting     = 0x2003, // Only change if cutting.
