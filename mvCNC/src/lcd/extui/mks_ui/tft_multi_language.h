...
typedef struct cutting_menu_disp {
  const char *title;
  const char *option;
  const char *temp1;
  const char *temp2;
...
extern cutting_menu_def cutting_menu;
...
typedef struct cutting_more_menu_disp {
  const char *title;
  const char *fan;
  ...
  const char *speed;
  const char *back;
} cutting_more_menu_def;

extern cutting_more_menu_def cutting_more_menu;
