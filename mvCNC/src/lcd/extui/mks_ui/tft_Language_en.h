...
#define DELTA_PRINT_RADIUS_EN           "CNC radius"
#define DELTA_HEIGHT_EN                 "CNC height"
...
#define PAUSE_POSITION_EN    "CNCing pause position settings"
...
#define DIALOG_UNBIND_PRINTER_EN            "Unbind the cnc?"
