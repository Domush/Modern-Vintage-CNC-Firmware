...
void ZOffsetScreen::runWizard() {
  ...
  AlertDialogBox::show(F("After the cnc finishes homing, adjust the Z Offset so that a sheet of paper can pass between the tool and bed with slight resistance."));
}
