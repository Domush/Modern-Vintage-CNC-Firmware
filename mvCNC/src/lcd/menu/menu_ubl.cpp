...
//
void mvCNCUI::ubl_mesh_edit_start(const_float_t initial) {
...
//
float mvCNCUI::ubl_mesh_value() { return rounded_mesh_value(); }
...
void _lcd_ubl_custom_mesh() {
  ...
  #if HAS_HOTEND
    EDIT_ITEM(int3, MSG_UBL_HOTEND_TEMP_CUSTOM, &custom_hotend_temp, EXTRUDE_MINTEMP, fanManager.hotend_max_target(0));
  #endif
  #if HAS_HEATED_BED
...
void _menu_ubl_tools() {
  ...
  void _menu_ubl_mesh_wizard() {
    ...
    #if HAS_HOTEND
      EDIT_ITEM(int3, MSG_UBL_HOTEND_TEMP_CUSTOM, &custom_hotend_temp, HEATER_0_MINTEMP + 20, fanManager.hotend_max_target(0));
    #endif
