...
void mvCNCUI::return_to_status() { goto_screen(status_screen); }

void mvCNCUI::push_current_screen() {
...
void mvCNCUI::_goto_previous_screen(TERN_(TURBO_BACK_MENU_ITEM, const bool is_back/*=false*/)) {
...
//
void mvCNCUI::synchronize(PGM_P const msg/*=nullptr*/) {
...
#if HAS_BUZZER
  void mvCNCUI::completion_feedback(const bool good/*=true*/) {
...
//
bool mvCNCUI::selection; // = false
bool mvCNCUI::update_selection() {
