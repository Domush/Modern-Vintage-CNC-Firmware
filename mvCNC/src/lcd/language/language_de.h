...
namespace Language_de {
  ...
  LSTR MSG_SET_ORIGIN                     = _UxGT("Setze Nullpunkte"); //"G92 X0 Y0 Z0" commented out in mvcncui.cpp
  #if HAS_PREHEAT
  ...
  LSTR MSG_RELEASE_MEDIA                  = _UxGT("Medium freigeben"); // if mvCNC gets confused - M22
