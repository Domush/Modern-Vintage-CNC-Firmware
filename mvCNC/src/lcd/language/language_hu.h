 ...
 * Hungarian / Magyar
 *
 * LCD Menu Messages. See also https://mvcncfw.org/docs/development/lcd_language.html
 ...
 *
 * LCD Menü Üzenetek. Lásd még https://mvcncfw.org/docs/development/lcd_language.html
