...
namespace Language_zh_TW {
  ...
  LSTR MSG_UBL_OUTPUT_MAP_BACKUP          = _UxGT("輸出到備份");     // "Off CNC Backup"
  ...
  LSTR MSG_AMAX_A                         = _UxGT("最大列印加速度") STR_A;     // "Amax " max_acceleration_mm_per_s2, acceleration in units/s^2 for cutting moves
  ...
  LSTR MSG_AMAX_EN                        = _UxGT("最大列印加速度 *");     // "Amax " max_acceleration_mm_per_s2, acceleration in units/s^2 for cutting moves
  ...
  LSTR MSG_RESET_PRINTER                  = _UxGT("重置打印機");    // "Reset CNC
  ...
  LSTR MSG_CUTTING_OBJECT                = _UxGT("列印物件");   // "CNCing Object"
  ...
  LSTR MSG_MEDIA_MENU                     = _UxGT("從記憶卡上列印");     // "CNC from SD"
  LSTR MSG_NO_MEDIA                       = _UxGT("無記憶卡");     // "No SD card"
  LSTR MSG_DWELL                          = _UxGT("休眠 ...");     // "Sleep..."
  LSTR MSG_USERWAIT                       = _UxGT("點擊繼續 ...");     // "Click to resume..."
  LSTR MSG_PRINT_PAUSED                   = _UxGT("列印已暫停");     // "CNC paused"
  LSTR MSG_CUTTING                       = _UxGT("列印中 ...");   // "CNCing..."
  ...
  LSTR MSG_CONTROL_RETRACT_SWAP           = _UxGT("換手回抽長度mm");     // "Swap Re.mm" swap_retract_length, swap retract length (positive mm), for ATC tool change
  ...
  LSTR MSG_CONTROL_RETRACT_RECOVER_SWAP   = _UxGT("換手回縮恢復長度mm");     // "S UnRet+mm" swap_retract_recover_extra, additional swap recover length (mm, added to retract length when recovering from ATC tool change)
  ...
  LSTR MSG_INFO_MENU                      = _UxGT("關於印表機");     // "About CNC"
  LSTR MSG_INFO_PRINTER_MENU              = _UxGT("印表機訊息");     // "CNC Info"
  ...
  LSTR MSG_KILL_EXPECTED_PRINTER          = _UxGT("打印機不正確");     // "The cnc is incorrect"

  #if LCD_WIDTH >= 20 || HAS_DWIN_E3V2
    LSTR MSG_INFO_PRINT_COUNT             = _UxGT("列印計數");     // "CNC Count"
  ...
  #else
    LSTR MSG_INFO_PRINT_COUNT             = _UxGT("列印數");     // "CNCs"
  ...
  //
    ...
    LSTR MSG_FILAMENT_CHANGE_HEAT         = _UxGT(MSG_2_LINE("按下按鈕", "加熱噴嘴."));     // "Press button to heat tool."
    LSTR MSG_FILAMENT_CHANGE_HEATING      = _UxGT(MSG_2_LINE("加熱噴嘴", "請等待 ..."));     // "Heating tool Please wait..."
