...
namespace Language_en {
  ...
  LSTR MSG_UBL_OUTPUT_MAP_BACKUP          = _UxGT("Off CNC Backup");
  ...
  LSTR MSG_RESET_PRINTER                  = _UxGT("Reset CNC");
  ...
  LSTR MSG_CONTINUE_PRINT_JOB             = _UxGT("Continue CNC Job");
  LSTR MSG_MEDIA_MENU                     = _UxGT("CNC from ") MEDIA_TYPE_EN;
  ...
  LSTR MSG_MOVE_NOZZLE_TO_BED             = _UxGT("Move Spindle to Bed");
  ...
  LSTR MSG_INFO_MENU                      = _UxGT("About CNC");
  LSTR MSG_INFO_PRINTER_MENU              = _UxGT("CNC Info");
  ...
  LSTR MSG_KILL_EXPECTED_PRINTER          = _UxGT("INCORRECT PRINTER");
    ...
    LSTR MSG_INFO_PRINT_COUNT_RESET       = _UxGT("Reset CNC Count");
    LSTR MSG_INFO_PRINT_COUNT             = _UxGT("CNC Count");
    LSTR MSG_INFO_PRINT_TIME              = _UxGT("CNC Time");
