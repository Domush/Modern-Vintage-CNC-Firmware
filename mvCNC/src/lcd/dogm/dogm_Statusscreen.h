...
/**
 * Standard mvCNC Status Screen bitmaps
 *
 * Use the mvCNC Bitmap Converter to make your own:
 * https://mvcncfw.org/tools/u8glib/converter.html
 */
...
#define BW(N) ((N + 7) / 8)
  ...
  #include "../../../_Statusscreen.h"
    ...
    #error "Your custom _Statusscreen.h needs to be converted for mvCNC 2.0."
  #endif
