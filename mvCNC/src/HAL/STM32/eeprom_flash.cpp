...
static_assert(0 == MVCNC_EEPROM_SIZE % 4,
              "MVCNC_EEPROM_SIZE must be a multiple of 4");  // Ensure copying as uint32_t is safe
static_assert(0 == FLASH_UNIT_SIZE % MVCNC_EEPROM_SIZE,
              "MVCNC_EEPROM_SIZE must divide evenly into your FLASH_UNIT_SIZE");
static_assert(FLASH_UNIT_SIZE >= MVCNC_EEPROM_SIZE,
              "FLASH_UNIT_SIZE must be greater than or equal to your MVCNC_EEPROM_SIZE");
static_assert(IS_FLASH_SECTOR(FLASH_SECTOR), "FLASH_SECTOR is invalid");
static_assert(IS_POWER_OF_2(FLASH_UNIT_SIZE),
              "FLASH_UNIT_SIZE should be a power of 2, please check your chip's spec sheet");
