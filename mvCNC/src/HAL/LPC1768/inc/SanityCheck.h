...
#define ANY_RX(N,V...) DO(IS_RX##N,||,V)
  ...
  #elif TOOL_CHANGE_SUPPORT && (IS_TX2(E1_ENABLE_PIN) || (AXIS_HAS_SPI(E1) && IS_TX2(E1_CS_PIN)))
    #error "Serial port pins (2) conflict with E1 stepper pins!"
  #elif ATC_TOOLS && ANY_RX(2, E0_DIR_PIN, E0_STEP_PIN)
  ...
  #elif TOOL_CHANGE_SUPPORT && (PIN_IS_TX3(E1_DIR) || PIN_IS_RX3(E1_STEP))
...
//
  ...
  #define USEDI2CDEV_M 1  // <Arduino>/Wire.cpp
    ...
    #elif TOOL_CHANGE_SUPPORT && (PIN_IS_SDA1(E1_DIR) || PIN_IS_SCL1(E1_STEP))
    ...
    #elif TOOL_CHANGE_SUPPORT && PIN_IS_SDA2(E1_ENABLE)
      #error "i2c SDA2 overlaps with E1 enable pin! Disable i2c peripherals."
    #elif TOOL_CHANGE_SUPPORT && AXIS_HAS_SPI(E1) && PIN_IS_SDA2(E1_CS)
      #error "i2c SDA2 overlaps with E1 CS pin! Disable i2c peripherals."
    #elif ATC_TOOLS && (PIN_IS_SDA2(E0_STEP) || PIN_IS_SDA2(E0_DIR))
