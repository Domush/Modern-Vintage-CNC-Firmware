...
#include "../../module/fan_control.h"
  ...
  #define mvCNC_UHS_WRITE_SS(v) WRITE(USB_CS_PIN, v)
  #define mvCNC_UHS_READ_IRQ()  READ(USB_INTR_PIN)
...
// mvCNC calls this function to check whether an USB drive is inserted.
...
// mvCNC calls this to initialize an SD card once it is inserted.
