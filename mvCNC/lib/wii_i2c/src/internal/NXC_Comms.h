...
#if defined(__MK20DX128__) || defined(__MK20DX256__) || defined(__MKL26Z64__) || defined(__MK64FX512__) || \
  defined(__MK66FX1M0__)  // Teensy 3.0/3.1-3.2/LC/3.5/3.6
  #include <i2c_t3.h>
...
namespace NintendoExtensionCtrl {
  ...
  inline boolean i2c_requestMultiple(NXC_I2C_TYPE &i2c, byte addr, uint8_t requestSize, uint8_t *dataOut) {
    i2c.setTimeout(100);
    uint8_t nBytesRecv = i2c.readBytes(dataOut, i2c.requestFrom(addr, requestSize));
