...
#if ANY(THERMAL_PROTECTION_CHAMBER, THERMAL_PROTECTION_COOLER)
 ...
 * Cooling fans
 *
 * Auto fans automatically turn on when their sensors'
 * temperatures go above *_AUTO_FAN_TEMPERATURE.
 *
 * Your board's pins file specifies the recommended pins. Override those here
 * or set to -1 to disable completely.
 *
 * Multiple fans can be assigned to the same pin in which case
 * the fan will turn on when any selected thermistor is above the threshold.
 */
...
#define DEFAULT_MINSEGMENTTIME        2000   // (µs) Set with M205 B.
...
// LCD CNC Progress options
   ...
   * mvCNC will embed all settings in the firmware binary as compressed data.
...
//
  ...
  //#define TFT_mvCNCUI_COLOR 0xFFFF // White
  //#define TFT_mvCNCBG_COLOR 0x0000 // Black
...
// #define REALTIME_COMMANDS
   ...
   *
   * Possible mvCNC statuses (GRBL-compatible equivalent)
...
// #define COMPACT_STATUS_REPORTS
  ...
  // #define GRBL_COMPATIBLE_STATES    // Report GRBL-equivalent states instead of mvCNC states
#endif

/**
 * Priority command execution
 *
 * When interacting using an attached mvCNC LCD display, changes such as babystepping and feed rates
 ...
 *
 * Requirements:
 *  - For Filament Change parking enable and configure SPINDLE_PARK_FEATURE.
 ...
 * mvCNC can be used to turn the spindle on and off. It can also be used to set
 * the spindle speed from 5,000 to 30,000 RPM.
 *
 * You'll need to select a pin for the ON/OFF function and optionally choose a 0-5V
 * hardware PWM pin for the speed control and a pin for the rotation direction.
 *
 * See https://mvcncfw.org/docs/configuration/laser_spindle.html for more config details.
 */
...
//#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
     ...
     */
    #if ENABLED(SPINDLE_LASER_USE_PWM)
      #define SPEED_POWER_INTERCEPT 100   // (%) 0-100 i.e., Minimum power percentage
      #define SPEED_POWER_MIN       18000 // (RPM)
      #define SPEED_POWER_MAX       30000 // (RPM) SuperPID router controller 0 - 30,000 RPM
      #define SPEED_POWER_STARTUP   30000 // (RPM) M3/M4 speed/power default (with no arguments)
    #endif
 ...
 *
 * mvCNC normally applies M106/M107 fan speeds at a time "soon after" processing
 ...
 *
 * If the SAFE_POWER_PIN is defined for your board, mvCNC will check
 ...
 */
//#define WIFISUPPORT         // mvCNC embedded WiFi managenent
